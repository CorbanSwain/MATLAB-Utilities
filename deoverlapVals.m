...
for iBin = 1:N
   if numInBin(iBin) > 0
      ...
      [binMembers, foI] = utils.funnelOrder(binMembers);      
      ...
      spreadDim(selection) = utils.zeroCenterVector(numInBin(iBin)) ...
         * jitterVal;
   end
end
end
...
function unittest
x = randn(1, 20);
[y, x2, I] = utils.deoverlapVals(x, 'MinBinSize', 0.25);
