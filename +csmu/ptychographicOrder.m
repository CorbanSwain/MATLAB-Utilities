%CSMU.PTYCHOGRAPHICORDER - Generates an inward spiraling index into an matrix.
%
%
%   Syntax:
%   -------
%   [ROWINDEXES, COLINDEXES] = CSMU.PTYCHOGRAPHICORDER(ARRAYSIZE) takes in a
...
%   --------
%      >> arrSize = [3, 3];
%      >> [ri, ci] = csmu.ptychographicOrder(arrSize)
%      
%      ri = 
%
%            1     1     1     2     3     3     3     2     2
...
if nRows > 1 && nCols > 1
   ...
   [remainingRowIndexes, remainingColIndexes] = ...
      csmu.ptychographicOrder(arraySize - 2);
