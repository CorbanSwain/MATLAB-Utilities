...
function unittest
L = csmu.Logger('csmu.getchunks>utest');
chunkSz = 30;
totalLength = 75;
L.assert(all(csmu.getchunks(chunkSz, totalLength) == [30, 30, 15]))
L.assert(all(csmu.getchunks(chunkSz, totalLength, 'balanced') == 25))
end